    ...
    <div className="w-full">
      ...
      <section className="relative h-screen">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('/pictures/reighandivorce2.jpg')" }}
      ...
      <section className="py-20 bg-neutral-900 text-white">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          >
            ...
            <Link 
              to="/booking" 
              className="inline-block px-8 py-3 bg-white text-neutral-900 hover:bg-neutral-200 transition-colors font-medium mx-2 mb-4"
            >
              Book a Session
            </Link>
            <Link 
              to="/contact" 
              className="inline-block px-8 py-3 border border-white text-white hover:bg-white hover:text-neutral-900 transition-colors font-medium mx-2 mb-4"
            >
              Contact Me
            </Link>
          </motion.div>
